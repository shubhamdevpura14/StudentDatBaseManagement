    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
   <div class="col-6">  <input type="text" class="form-control" placeholder="FIRST NAME" name="fname" required><br></div>
   <div class="col-6">  <input type="text" class="form-control" placeholder="LAST NAME" name="lname" required><br></div>
  </div>
  
    <input type="text" class="form-control" placeholder="CURRENT ADDRESS" name="caddress" required><br>

<input type="text" class="form-control" placeholder="CONTACT NO." name="contact" required><br>
...
<input type="email" class="form-control" placeholder="EMAIL" name="email"><br>
 ...
 <div class="row">
   ...
   <div class="col-6">   <input type="text" class="form-control" placeholder="ENROLLMENT YEAR" name="eyear" required><br></div>
  </div>

<input type="text" class="form-control" placeholder="ENROLLMENT NO." name="enroll" required>
  <br>
      <div class="row">
   <div class="col-6">  
  ...
  <div class="row">
   <div class="col-6">
    ...
    <input type="TEXT" class="form-control"  placeholder="FATHER'S NAME" name="father_name" required><br>
   </div>
      <div class="col-6">
...
<div class="col-9">
     <input type="TEXT" class="form-control"  placeholder="PHONE NO." name="fcontact" ><br>
</div>
</div>
	  </div>
  </div>
  ...
  <div class="row">
   <div class="col-6">
      <input type="TEXT" class="form-control"  placeholder="MOTHER'S NAME" name="mother_name" required><br>
  </div>
  <div class="col-6">
...
<div class="col-9">
     <input type="TEXT" class="form-control"  placeholder="PHONE NO." name="mcontact"><br>
</div>
</div>
</div>
  </div>
 
	 <input type="TEXT" class="form-control"  placeholder="EMAIL ID" name="pemail"><br>
